...
Serial.println("AT+CMGS=\"9148300815\"");delay(400);
...
Serial.println("AT+CMGF=1");delay(400);Serial.println("AT+CMGS=\"9148300815\"");delay(400);   // use your 10 digit cell no. here
